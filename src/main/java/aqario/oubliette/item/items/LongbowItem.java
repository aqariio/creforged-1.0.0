...
public class LongbowItem
    ...
    public static final int field_30855 = 100;
    ...
    public void onStoppedUsing(ItemStack stack, World world, LivingEntity user, int remainingUseTicks) {
        ...
        if ((double)(f = getPullProgress(i = this.getMaxUseTime(stack) - remainingUseTicks)) < 0.1) {
            return;
        }
    ...
    @Override
    public int getMaxUseTime(ItemStack stack) {return 120000;}
