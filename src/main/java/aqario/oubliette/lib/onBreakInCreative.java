...
public class onBreakInCreative extends PlantBlock {
    public static final EnumProperty<DoubleBlockHalf> HALF = Properties.DOUBLE_BLOCK_HALF;

    protected onBreakInCreative(Settings settings) {
        super(settings);
    }

    public void TallPlantBlock(Settings settings) {
