package aqario.oubliette.world.structure.structures;
...
public class OublietteStructure extends StructureFeature<StructurePoolFeatureConfig> {

    public OublietteStructure() {
        // Create the pieces layout of the structure and give it to the game
        super(StructurePoolFeatureConfig.CODEC, OublietteStructure::createPiecesGenerator, PostPlacementProcessor.EMPTY);
    }
    ...
    private static boolean isFeatureChunk(StructureGeneratorFactory.Context<StructurePoolFeatureConfig> context) {
        ...
        // Checks to make sure our structure does not spawn within 10 chunks of a Stronghold
    ...
    public static Optional<StructurePiecesGenerator<StructurePoolFeatureConfig>> createPiecesGenerator(StructureGeneratorFactory.Context<StructurePoolFeatureConfig> context) {
        ...
        if (!OublietteStructure.isFeatureChunk(context)) {
        ...
        blockpos = blockpos.down(topLandY - 60);
        ...
        if(structurePiecesGenerator.isPresent()) {
            ...
            Oubliette.LOGGER.log(Level.DEBUG, "Oubliette at {}", blockpos);
        }
